...
Weapons have a damage type or combination of damage types that they apply.
These are:
...
In addition to the type of damage a weapon can do, armaments are also distinguished in their
size (small, medium, large, and huge) and other properties. These can include:
