...
Chi powers burst, defense, recovery, transfer, and special techniques. It rises
through meditation, clean combos, training, hard survival, and style triggers.
It falls when spent on advanced techniques.
...
Styles change which attacks flow cleanly and which recovery options feel
natural.
...
Notches record training victories, formal tests, and memorable fights.
Challenges open higher training, stronger combos, and better Chi control.
